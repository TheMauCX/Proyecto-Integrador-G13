...
<html>
    ...
    <body>
        ...
        <div class="container" style="padding-left: 200px;">
            <h3 class="container text-xl-center p-4">MANTENER ACCESO</h3>
            <div class="py-4">
                ...
                <table class="table">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Nuevo Acceso</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form>
                                        <div class="mb-3">
                                            <label for="recipient-name" class="col-form-label">Acceso: </label>
                                            <input type="text" class="form-control" id="acceso" name="">
                                        </div>
                                    </form>
                                </div>
                    ...
                    <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Editar Acceso</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form>
                                        <div class="mb-3">
                                            <label for="recipient-name" class="col-form-label">Acceso: </label>
                                            <input type="text" class="form-control" id="acceso_edit" name="">
                                            <label for="recipient-name" class="col-form-label">Estado: </label>
                                            <input type="text" class="form-control" id="estado_edit" name="">
                                            <input type="hidden" class="form-control" id="id_acceso_edit" name="">
                                        </div>
                                    </form>
                                </div>
                                <div class="modal-footer">
